define(["jquery", "underscore", "qlik", "translator", "ng!$q", "ng!$http", "./properties", "./initialproperties", "client.utils/state", "objects.backend-api/field-api", "./lib/js/extensionUtils", "./lib/js/moment", "./lib/js/daterangepicker", "general.models/library/dimension", "text!./lib/css/style.css", "text!./lib/css/daterangepicker.css", "text!./lib/partials/template.html", "./lib/js/clTouch", "./lib/js/onLastRepeatDirective"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
    ...
    function u(a, c, d) {
        ...
        return a &&
            (
                e = b.isNumber(Number(a)) 
                    && Number(a) < 1e5 ? t(a, c, d) 
                    :  d ?  
                            l.utc(a, c, !1).format(c) :  
                            s(l.utc(a, c, !1)).format(c)
            ), 
        e
    }
    ...
    return v && "/" !== v.substr(0, 1) && (v = "/" + v), o = o.replace(new RegExp("__VirtualProxyPrefix__", "g"), v), k.addStyleToHeader(o), k.addStyleToHeader(p), {
        ...
        controller: ["$scope", "$element", function(e, f) {
            ...
            var g = c.currApp(),
                h = g.model.layout.qLocaleInfo,
                j = b.clone(h.qCalendarStrings.qDayNames);
            j.unshift(j.pop());
            var k = (h.qFirstWeekDay + 1) % 6;
            e.format = {
                CollationLocale: h.qCollation,
                DateFormat: h.qDateFmt,
                MonthNames: h.qCalendarStrings.qMonthNames,
                FirstWeekDay: k,
                DayNames: j
            }, e.selections = {
                field: "",
                ...
                a("[id^=daterangepicker-container-" + e.qId + "]").remove(), b.each(e.fields, function(c) {
                    if ("DATERANGE" === c.type) {
                        ...
                        null != c.dateStart && null != c.dateEnd && (j.startDate = c.dateStart, j.endDate = c.dateEnd), 
                        null != c.dateMin && null != c.dateMax && (j.minDate = c.dateMin, j.maxDate = c.dateMax),
                        //null != c.singleDatePicker && (j.startDate = c.dateStart, j.endDate = c.startDate)
                        c.dateRanges && (j.ranges = {}, b.each(c.dateRanges, function(a) {
                    ...
                    switch (c.listType) {
                        ...
                        case "DATERANGE":
                            var o = "",
                                ...
                                x = u(c.date.initSelectionFrom, r, !0),
                                y = u(c.date.initSelectionTo, r, !0),
                                sdx = u(c.date.initSelection, r, !0),
                            ...
                            c.qListObject.qDimensionInfo.qStateCounts.qSelected > 0 ? 
                                (c.qListObject.qDimensionInfo.qStateCounts.qSelected < c.date.max - c.date.min + 1 && (D = !0), 
                                    p =  c.date.singleDate ? u(c.date.min, r) : u(c.date.min, r), 
                                    q =  c.date.singleDate ? u(c.date.min, r) : u(c.date.max, r), 
                                    o = c.date.singleDate ? u(c.date.min, s) : u(c.date.min, s) + " - " + u(c.date.max, s)) 
                ...
                a = "=" === a.substring(0, 1) ? a.substring(1, a.length) : a, g.field(a).selectMatch(">=" + b + "<=" + c, d).then(function() {})
            }, e.selectFieldValues = function(a, c, d) {
                a = "=" === a.substring(0, 1) ? a.substring(1, a.length) : a;
                var e = [];
                b.each(c, function(a) {
                    e.push(JSON.parse(a))
                }), g.field(a).selectValues(e, d)["catch"](function(a) {})
            }, e.setVariable = function(a, b) {
                g.variable.setStringValue(a, b).then(function() {})
                ...
                g.getObject(d.sheetId).then(function(c) {
                    var d = [];
                    b.each(c.layout.cells, function(a) {
                        "linechart" === a.type && d.push(a.name)
                    }), b.each(d, function(c) {
                        g.getObjectProperties(c).then(function(d) {
                            g.getObject(c).then(function(f) {
                ...
                if (e.willApplyInitSelections) {
                    b.each(e.fields, function(a) {
                        if ("VARIABLE" !== a.type && "DATERANGE" !== a.type && "" !== a.initSelection) {
                            var c = ["=", "<", ">"];
                            if (c.indexOf(a.initSelection.substring(0, 1)) > -1) g.field(a.field).clear(), g.field(a.field).selectMatch(a.initSelection);
                            else {
                                var d = [],
                        ...
                        "VARIABLE" === a.type && "" !== a.initSelection && e.setVariable(a.variable, a.initSelection), 
                        "DATERANGE" === a.type && "" !== a.dateFromInitSelection && "" !== a.dateToInitSelection && !a.singleDatePicker && e.selectDateFromAndTo(a.field, a.dateFromInitSelection, a.dateToInitSelection, !1)
                        "DATERANGE" === a.type && "" !== a.dateInitSelection && a.singleDatePicker && e.selectDateFromAndTo(a.field, a.dateInitSelection, a.dateInitSelection, !1)
                    });
                    var a = {
                        selectionApplied: !0
                    };
