define(["underscore", "./lib/js/components/pp-cl-about/pp-cl-about"], function(a) {
    ...
    var b = function(a) {
            if ("DATERANGE" === a.listType) {
                ...
                a.date.min.qValueExpression.qExpr = "=Min(" + b + ")", 
                a.date.max.qValueExpression.qExpr = "=Max(" + b + ")",
                a.date.sdate.qValueExpression.qExpr = "=Min(" + b + ")"
            } else a.date.min.qValueExpression.qExpr = "", a.date.max.qValueExpression.qExpr = "", a.date.sdate.qValueExpression.qExpr = ""
        },
        c = [{
            value: "TODAY",
            label: "Today"
        ...
        d = {
            ...
            items: {
                ...
                sdate: {
                    type: "string",
                    ref: "date.sdate.qValueExpression.qExpr",
                    expression: "always",
                    defaultValue: "",
                    show: !1
                },
